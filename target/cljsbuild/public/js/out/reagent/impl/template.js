...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29945__auto__,writer__29946__auto__,opt__29947__auto__){
return cljs.core._write.call(null,writer__29946__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__29339__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__29339__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__29339__auto__)){
return or__29339__auto__;
} else {
...
var G__32547 = o;
(G__32547[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__32549__i < G__32549__a.length) {G__32549__a[G__32549__i] = arguments[G__32549__i + 0]; ++G__32549__i;}
  args = new cljs.core.IndexedSeq(G__32549__a,0);
} 
...
var old_32551 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_32551))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_32551)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__29327__auto__ = (node === document.activeElement);
if(and__29327__auto__){
var and__29327__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__29327__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__32554 = jsprops;
(G__32554["defaultValue"] = value);

(G__32554["onChange"] = ((function (G__32554,v,value,on_change){
return (function (p1__32552_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32552_SHARP_);
});})(G__32554,v,value,on_change))
);
...
var vec__32556 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32556,(0),null);
var id = cljs.core.nth.call(null,vec__32556,(1),null);
var class$ = cljs.core.nth.call(null,vec__32556,(2),null);
...
var temp__4659__auto__ = (function (){var G__32560 = cljs.core.meta.call(null,v);
if((G__32560 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__32560);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__32562_32563 = v;
var G__32562_32564__$1 = (((G__32562_32563 == null))?null:reagent.impl.template.key_from_vec.call(null,G__32562_32563));
if((G__32562_32564__$1 == null)){
} else {
(jsprops["key"] = G__32562_32564__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__32567 = cljs.core.meta.call(null,argv);
if((G__32567 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__32567);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__32568 = (((jsprops == null))?{}:jsprops);
(G__32568["key"] = key);
...
var G__32569 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32569;
continue;
}
} else {
...
var n__30253__auto___32570 = a.length;
var i_32571 = (0);
while(true){
if((i_32571 < n__30253__auto___32570)){
(a[i_32571] = reagent.impl.template.as_element.call(null,(a[i_32571])));
...
var a = cljs.core.into_array.call(null,s);
var n__30253__auto___32573 = a.length;
var i_32574 = (0);
while(true){
if((i_32574 < n__30253__auto___32573)){
var val_32575 = (a[i_32574]);
if((cljs.core.vector_QMARK_.call(null,val_32575)) && ((reagent.impl.template.key_from_vec.call(null,val_32575) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32574] = reagent.impl.template.as_element.call(null,val_32575));
...
if(cljs.core.truth_((function (){var and__29327__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__29327__auto__){
return (ctx["no-key"]);
} else {
return and__29327__auto__;
...
var G__32578 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32578) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32578){
