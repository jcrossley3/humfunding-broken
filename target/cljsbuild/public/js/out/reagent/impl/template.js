...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6722__auto__,writer__6723__auto__,opt__6724__auto__){
return cljs.core._write(writer__6723__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__6116__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__6116__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__6116__auto__)){
return or__6116__auto__;
} else {
...
var G__13573 = o;
(G__13573[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_13577 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_13577))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_13577)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__6104__auto__ = (node === document.activeElement);
if(and__6104__auto__){
var and__6104__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__6104__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__13580 = jsprops;
(G__13580["defaultValue"] = value);

(G__13580["onChange"] = ((function (G__13580,v,value,on_change){
return (function (p1__13578_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13578_SHARP_);
});})(G__13580,v,value,on_change))
);
...
var vec__13582 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13582,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13582,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13582,(2),null);
...
var temp__4659__auto__ = (function (){var G__13586 = cljs.core.meta(v);
if((G__13586 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__13586);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__13588_13589 = v;
var G__13588_13590__$1 = (((G__13588_13589 == null))?null:reagent.impl.template.key_from_vec(G__13588_13589));
if((G__13588_13590__$1 == null)){
} else {
(jsprops["key"] = G__13588_13590__$1);
}
...
var G__13594 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13594) : reagent.impl.template.as_element.call(null,G__13594));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__13595 = cljs.core.meta(argv);
if((G__13595 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__13595);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__13596 = (((jsprops == null))?{}:jsprops);
(G__13596["key"] = key);
...
var G__13597 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13597;
continue;
}
} else {
...
var n__7030__auto___13598 = a.length;
var i_13599 = (0);
while(true){
if((i_13599 < n__7030__auto___13598)){
(a[i_13599] = reagent.impl.template.as_element((a[i_13599])));

var G__13600 = (i_13599 + (1));
i_13599 = G__13600;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7030__auto___13601 = a.length;
var i_13602 = (0);
while(true){
if((i_13602 < n__7030__auto___13601)){
var val_13603 = (a[i_13602]);
if((cljs.core.vector_QMARK_(val_13603)) && ((reagent.impl.template.key_from_vec(val_13603) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13602] = reagent.impl.template.as_element(val_13603));

var G__13604 = (i_13602 + (1));
i_13602 = G__13604;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__6104__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6104__auto__){
return (ctx["no-key"]);
} else {
return and__6104__auto__;
...
var G__13606 = (cljs.core.count(argv) - first_child);
switch (G__13606) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13606){
