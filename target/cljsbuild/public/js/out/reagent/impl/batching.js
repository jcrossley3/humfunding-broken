...
var or__6116__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6116__auto__)){
return or__6116__auto__;
} else {
var or__6116__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6116__auto____$1)){
return or__6116__auto____$1;
} else {
var or__6116__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6116__auto____$2)){
return or__6116__auto____$2;
} else {
var or__6116__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__7030__auto__ = a.length;
var i = (0);
while(true){
if((i < n__7030__auto__)){
var c_13465 = (a[i]);
if(cljs.core.truth_((c_13465["cljsIsDirty"]))){
(c_13465["forceUpdate"])();
} else {
}
...
var G__13468 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__13468) : reagent.impl.batching.next_tick.call(null,G__13468));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__6722__auto__,writer__6723__auto__,opt__6724__auto__){
return cljs.core._write(writer__6723__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__13470 = c;
var G__13470__$1 = (((G__13470 == null))?null:(G__13470["props"]));
if((G__13470__$1 == null)){
return null;
} else {
return (G__13470__$1["argv"]);
}
});
...
var G__13472_13473 = (c["cljsRatom"]);
if((G__13472_13473 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13472_13473);
}
