...
var or__29339__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__29339__auto__)){
return or__29339__auto__;
} else {
var or__29339__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__29339__auto____$1)){
return or__29339__auto____$1;
} else {
var or__29339__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__29339__auto____$2)){
return or__29339__auto____$2;
} else {
var or__29339__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__30253__auto__ = a.length;
var i = (0);
while(true){
if((i < n__30253__auto__)){
var c_32483 = (a[i]);
if(cljs.core.truth_((c_32483["cljsIsDirty"]))){
(c_32483["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__29945__auto__,writer__29946__auto__,opt__29947__auto__){
return cljs.core._write.call(null,writer__29946__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__32487 = c;
var G__32487__$1 = (((G__32487 == null))?null:(G__32487["props"]));
if((G__32487__$1 == null)){
return null;
} else {
return (G__32487__$1["argv"]);
}
});
...
var G__32489_32490 = (c["cljsRatom"]);
if((G__32489_32490 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__32489_32490);
}
