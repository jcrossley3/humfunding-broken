...
var len__30408__auto___31357 = arguments.length;
var i__30409__auto___31358 = (0);
while(true){
if((i__30409__auto___31358 < len__30408__auto___31357)){
args__30415__auto__.push((arguments[i__30409__auto___31358]));

var G__31359 = (i__30409__auto___31358 + (1));
i__30409__auto___31358 = G__31359;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__30416__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq31356){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31356));
});
/**
...
var G__31362 = cljs.core.reduce.call(null,((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__31360_SHARP_,p1__31360_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__31363 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__4655__auto__){
return (function (p1__31361_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__31361_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__31362;
state = G__31363;
...
var G__31364 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),(cljs.core.truth_(escape_QMARK_)?cljs.core.seq.call(null,markdown.common.escape_code.call(null,clojure.string.join.call(null,buf))):buf),cljs.core.seq.call(null,close)));
var G__31365 = cljs.core.PersistentVector.EMPTY;
var G__31366 = cljs.core.rest.call(null,tokens);
var G__31367 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__31364;
buf = G__31365;
tokens = G__31366;
cur_state = G__31367;
...
var G__31368 = out;
var G__31369 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__31370 = cljs.core.rest.call(null,tokens);
var G__31371 = cur_state;
out = G__31368;
buf = G__31369;
tokens = G__31370;
cur_state = G__31371;
...
var G__31372 = out;
var G__31373 = buf;
var G__31374 = cljs.core.rest.call(null,tokens);
var G__31375 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__31372;
buf = G__31373;
tokens = G__31374;
cur_state = G__31375;
...
var G__31376 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__31377 = buf;
var G__31378 = cljs.core.rest.call(null,tokens);
var G__31379 = cur_state;
out = G__31376;
buf = G__31377;
tokens = G__31378;
cur_state = G__31379;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__31380_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__31380_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__31381_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__31381_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__31381_SHARP_));
