...
if(cljs.core.truth_((function (){var or__29600__auto__ = new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__29600__auto__ = markdown.transformers.h1_QMARK_.call(null,text);
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
...
var G__37270 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
...
if(cljs.core.truth_((function (){var or__29600__auto__ = new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last.call(null,(2),text))) && (cljs.core.not.call(null,(function (){var or__29600__auto__ = code;
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
return lists;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__29600__auto__ = new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
...
if(cljs.core.truth_((function (){var and__29588__auto__ = cljs.core.not.call(null,last_line_empty_QMARK_);
...
if(cljs.core.truth_((function (){var and__29588__auto__ = paragraph__$1;
if(cljs.core.truth_(and__29588__auto__)){
return lists;
} else {
return and__29588__auto__;
...
if(cljs.core.truth_((function (){var or__29600__auto__ = heading;
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
...
if(cljs.core.truth_((function (){var or__29600__auto__ = eof;
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__29588__auto__ = cljs.core.not.call(null,eof);
if(and__29588__auto__){
...
if(cljs.core.truth_((function (){var or__29600__auto__ = lists;
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
return codeblock;
...
if(cljs.core.truth_((function (){var and__29588__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take.call(null,(3),trimmed));
if(and__29588__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__29588__auto__;
...
if(cljs.core.truth_((function (){var and__29588__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),trimmed));
if(and__29588__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__29588__auto__;
...
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__37298_SHARP_),cljs.core.str("</ol>")].join('');
