...
return clojure.string.join.call(null,(function (){var iter__30380__auto__ = (function markdown$lists$close_lists_$_iter__37249(s__37250){
...
cljs.core.chunk_append.call(null,b__37252,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''));
...
return cljs.core.cons.call(null,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''),markdown$lists$close_lists_$_iter__37249.call(null,cljs.core.rest.call(null,s__37250__$2)));
}
} else {
return null;
}
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__29600__auto__ = markdown.common.make_heading.call(null,content,false);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__29600__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
return content;
...
if(cljs.core.truth_((function (){var and__29588__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__29588__auto__ = lists;
if(cljs.core.truth_(and__29588__auto__)){
...
if(cljs.core.truth_((function (){var and__29588__auto__ = (function (){var or__29600__auto__ = eof;
if(cljs.core.truth_(or__29600__auto__)){
return or__29600__auto__;
} else {
