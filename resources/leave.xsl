      ...
      <fo:table-body start-indent="0.5pc" text-align="start">
        ...
        <fo:table-row>
          <fo:table-cell border-style="solid" border-width="0.5pt">
            ...
            <fo:block>
              ...
              select="project/startDate/@value"/></fo:inline> 
              to <fo:inline font-weight="bold" font-size="9pt"><xsl:value-of 
              select="project/endDate/@value"/></fo:inline> 
            </fo:block>
          </fo:table-cell>
          <fo:table-cell border-style="solid" border-width="0.5pt">
            <fo:block>&#160;</fo:block>
        ...
        <fo:table-row>
          <fo:table-cell border-style="solid" border-width="0.5pt" number-columns-spanned="2">
            ...
            <fo:block>
              <xsl:choose>
                <xsl:when test="not(budget/requestedBudget/wages/@amt='$0.00') or
                                not(budget/requestedBudget/supplies/@amt='$0.00') or
                                not(budget/requestedBudget/travel/@amt='$0.00') or
                                not(budget/requestedBudget/other/@amt='$0.00')">
                  <xsl:call-template name="checkedBox"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:call-template name="unCheckedBox"/>
        ...
        <fo:table-row>
	      ...
	      <xsl:if test="approval/committeeResponse">
                ...
                <xsl:value-of select="approval/committeeResponse/@responseDate"/>
	      </xsl:if>
            </fo:block>
          </fo:table-cell>
          <fo:table-cell border-style="solid" border-width="0.5pt">
            ...
            <fo:block>
              ...
              <fo:block font-weight="bold" text-decoration="underline">
                <xsl:choose>
                  ...
                  <xsl:value-of select="approval/chairResponse/@responseDate"/>
                  </xsl:when>
                </xsl:choose>
              </fo:block>
            </fo:block>
        ...
        <fo:table-row>
          ...
          <fo:table-cell border-style="solid" border-width="0.5pt">
            ...
            <xsl:value-of 
                select="approval/deaneryResponse/@responseDate"/>
            </fo:block>
          </fo:table-cell>
        </fo:table-row>
        <fo:table-row>
